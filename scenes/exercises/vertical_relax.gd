...
var pause_step1 = 0.25 # default value
var pause_step2 = 0.25 # default value
...
func start(total_duration_sec: int):
	...
	step1_duration_sec = step_config.get_node("step_duration").value
	step2_duration_sec = step_config.get_node("step_duration").value
	_start()
